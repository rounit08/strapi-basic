...
export interface ApiHeaderHeader extends Schema.CollectionType {
  ...
  attributes: {
    StrapiAI: Attribute.String & Attribute.Unique;
    Products: Attribute.Component<'components.navitems'>;
...
export interface ApiSchoolSchool extends Schema.CollectionType {
  ...
  attributes: {
    Name_of_schoool: Attribute.String & Attribute.Required;
    CBSE: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
